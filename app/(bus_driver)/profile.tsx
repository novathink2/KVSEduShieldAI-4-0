        ...
        <ScrollView contentContainerStyle={styles.content}>
          <Card>
            <View style={styles.row}>
              <View style={[styles.avatar, { backgroundColor: '#10B981' }]}>
                <MaterialCommunityIcons name="steering" color="#fff" size={28} />
              </View>
          ...
          {editMode ? (
            <Card style={{ marginTop: Spacing.lg }}>
              ...
              <Text style={[styles.formLabel, { marginTop: Spacing.lg }]}>Bus Number</Text>
              <TextInput value={busNumber} onChangeText={setBusNumber} style={styles.input} placeholder="e.g. Bus 1" placeholderTextColor={Colors.textMuted} />
            ...
            <Card padded={false} style={{ marginTop: Spacing.lg }}>
              <View style={styles.infoRow}>
                <MaterialCommunityIcons name="bus" color={Colors.primary} size={20} />
                <Text style={styles.infoLabel}>Bus</Text>
                <Text style={styles.infoValue}>{user?.busNumber ?? 'Not assigned'}</Text>
              </View>
              ...
              <View style={{ height: 1, backgroundColor: Colors.border, marginHorizontal: Spacing.lg }} />
              <View style={styles.infoRow}>
                <MaterialCommunityIcons name="email" color={Colors.primary} size={20} />
